...
//            <div>
//             <a href="" className='font-black text-xl items-center flex gap-1'>
...
//                 border-gray-300 py-1 px-2 text-sm 
...
//             {Menu.map((data)=> (
//               <li key={data.id}>
//                 <a href={data.link} className='inline-block p-4 hover:[#4263eb] duration-200'>{data.name}</a>
//               </li>
//             ))}
...
//                     Tranding Products
//                     <span>
//                         <FaCarrot className='transition-all duration-200 group-hover:rotate-180'/>
//                     </span>
//                 </a>
...
//                             <li key={data.id} >
//                                 <a href={data.link} className='inline-block w-full rounded-md p-2 hover:[#4263eb]'>
//                                     {data.name}
//                                 </a>
//                             </li>
//                         ))}
